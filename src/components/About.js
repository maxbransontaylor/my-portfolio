...
function About() {
  ...
  return (
    <section className={`about-page ${pageLoad ? "yopacity" : "nopacity"}`}>
      ...
      <p id="about-text">
        ...
        essential. I try to consider a wide range of users and develop intuitive
        features before they might be asked for.
      </p>
    </section>
  );
}
